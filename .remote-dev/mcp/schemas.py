...
TOOL_SCHEMAS: dict[str, dict[str, Any]] = {
    ...
    "remote.bash": schema({"command": {"type": "string"}, "description": {"type": "string"}, "timeout_ms": {"type": "integer"}, "timeout": {"type": "integer"}, "run_in_background": {"type": "boolean"}, "approve_disruptive_action": {"type": "boolean", "description": "Set only after user approval for an NPU/host reset or outside-target process termination."}, "env": {"type": "object", "additionalProperties": {"type": "string"}}}, ["command"]),
    ...
    "remote.monitor": schema({"command": {"type": "string"}, "description": {"type": "string"}, "timeout_ms": {"type": "integer"}, "pattern": {"type": "string"}, "approve_disruptive_action": {"type": "boolean", "description": "Set only after user approval for an NPU/host reset or outside-target process termination."}, "env": {"type": "object", "additionalProperties": {"type": "string"}}}, ["command"]),
    "remote.apply_patch": {
